...
class NewYork extends Component {
  ...
  render() {
    ...
    const filteredAllNewYorkCityData= AllNewYorkCityData.filter(NYCDaya => NYCDaya.headline.toLowerCase().includes(experience.toLowerCase())
    || NYCDaya.description.toLowerCase().includes(experience.toLowerCase())
    || NYCDaya.sectionData.some(item => item && item.description && item.description.toLowerCase().includes(experience.toLowerCase()))
    )
    return (
      <div className="new-york-wrapper">
        ...
        {filteredAllNewYorkCityData &&
          filteredAllNewYorkCityData.map(
