...
import LoveTravelLogo from './Images/lovetravellogo.png';
    ...
    <div className='footer-wrap'>
        <div className='footer-wrapper'>
            <div className='column-one'>
                <img id="footer" src={LoveTravelLogo} alt="LoveTravel" />
                <p>Building the future of how we experience our cities.</p>
                <p
                style={{
                    color: '#2980b9',
                    fontSize: '14px'
